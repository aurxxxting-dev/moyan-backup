...
| L3 项目快照 | `memory/project-index/*-summary.md` | 项目关键设定、进度、伏笔 | 每章更新 |
| L4 正文存档 | `memory/articles/项目名/` | 章节正文详细内容 | 写作时存储 |

### 新机制：书签 + 书架（2026-03-09 建立）

**核心逻辑**：
- **主记忆（书签）**：只记录"写了《XXX》第X章，日期"，轻量可搜索
- **书架（正文）**：`memory/articles/项目名/日期-章节.md`，按需加载
- **项目快照**：`memory/project-index/项目-summary.md`，续写时读取，避免全文重读

**续写流程**：
```
用户说"继续写《XXX》"
  ↓
读 memory/project-index/XXX-summary.md（关键设定、人物状态、伏笔）
  ↓
读 articles/XXX/最近1-2章.md（文风连贯）
  ↓
开始续写
  ↓
写完后更新 summary.md（添加新进度、伏笔）
```

**存储规则**：
- 日常对话：写入 `memory/YYYY-MM-DD.md`
- 章节正文：写入 `memory/articles/项目名/日期-章节名.md`
- 项目快照：写入 `memory/project-index/项目名-summary.md`
- 搜索范围：默认只搜 `memory/*.md`，不扫 `articles/`（避免正文污染搜索结果）
...
#### 《富可敌国的我》
- **类型**：历史架空/多女主/权谋
- **进度**：已完成第1-13章，等待继续第十四章
- **快照**：`memory/project-index/富可敌国的我-summary.md`
- **素材**：
  - 大纲：`memory/project-富可敌国的我-大纲.md`
  - 人物卡：`memory/project-富可敌国的我-人物卡.md`
  - 正文存档：`memory/articles/富可敌国的我/`
- **待办**：
  - [ ] 继续第十四章（待aur确认方向）
...
- **类型**：穿越/唐朝/群像/日常/人物弧光
- **进度**：第一章筹备中
- **快照**：`memory/project-index/大唐群像-summary.md`
- **正文存档**：`memory/articles/大唐群像/`
- **核心设定**：
  - 主角：已富可敌国，现代平等观念，洒脱不羁
  - 系统：平时不用，万分危机才用
  - 双女主：落魄世家大小姐 × 边塞胡女
  - 风格：日常细节，人物成长，小小净土
- **待办**：
...
- **核心设定**：
  - 系统AI出bug，任务目标识别错误
  - 击败恶龙→打死流浪狗，判定成功，奖励屠龙刀
  - 追求校花→追错人追到修仙大佬，奖励双修功法
- **爽点**：躺赢+阴差阳错的喜剧感
- **待办**：
  - [ ] 人物设定
  - [ ] 世界观细化
...
- **类型**：恐怖/副本/生活流/反向操作
- **进度**：立项完成，开始第一章
- **快照**：`memory/project-index/恐怖副本民宿-summary.md`
- **正文存档**：`memory/articles/恐怖副本民宿/`
- **核心设定**：
  - 全球诡异副本入侵，别人逃生，主角选最安全副本直接住下
  - 鬼新娘敲门→递红糖水，断头鬼飘客厅→互利互惠
  - 其他玩家战战兢兢通关，主角在副本里财务自由
- **爽点**：反向操作+与恐怖共存的生活流
- **待办**：
  - [ ] 主角设定
  - [ ] 第一个副本详细设定
